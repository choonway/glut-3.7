...
// additional stuff required for better integration
extern void APIENTRY glutWinProc(WNDPROC w);
extern void APIENTRY glutTick(void);
extern int APIENTRY glutMatchHWND(HWND hwnd);
extern HWND APIENTRY glutGetHWND(int w);
